...
namespace Paradox
{
	...
	public:
		...
		static bool ImageButton(const char* id, Shared<class Texture2D> texture, const ImVec2& size, const ImVec4& tint = ImVec4(1, 1, 1, 1), const ImVec4& bgTint = ImVec4(0, 0, 0, 0), const ImVec2& uv0 = ImVec2(0, 0), const ImVec2& uv1 = ImVec2(1, 1));
