...
namespace Paradox
{
		...
		: m_DebugName(debugName)
	{
		...
		VulkanUtils::SetDebugName(VK_OBJECT_TYPE_IMAGE, m_Image, m_DebugName);
		...
		VulkanUtils::SetDebugName(VK_OBJECT_TYPE_IMAGE_VIEW, m_ImageView, m_DebugName + " (ImageView)");
		...
		VulkanUtils::SetDebugName(VK_OBJECT_TYPE_SAMPLER, m_Sampler, m_DebugName + " (Sampler)");

		PX_CORE_TRACE("Created Texture: {0} ({1}x{2})", m_DebugName, m_Width, m_Height);
	}
